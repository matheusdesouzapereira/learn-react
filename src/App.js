    ...
    <div className="container">
      ...
      <main>
        ...
        <section className="box-requisitos">
          <h2>Requisitos</h2>
          <p>Veja abaixo os requisitos mínimos para apredner React JS:</p>

          <div className="box-cards">
            <div className="card">
              <h3>HTML</h3>
              <p>Apredner a estruturar os elementos da página com HTML</p>
            </div>
      ...
      <footer>
        <p className="autor">Curso de instrodução de React JS | By Matheus Pereira</p>
      </footer>
    </div>
  );
}
